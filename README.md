...
## 블랙잭(Blackjack)
- [x] 플레이어의 첫 2장이 블랙잭이면 딜러에게 베팅 금액의 1.5배 만큼의 금액을 받는다.
- [x] 플레이어의 첫 2장이 블랙잭이고 딜러도 블랙잭이라면 딜러에게 베팅 금액을 돌려 받는다.
- [x] 플레이어가 딜러에게 이기면 베팅한 금액을 받는다.
- [x] 플레이어가 딜러에게 진다면 베팅한 금액을 잃는다.
- [x] 플레이어가 딜러와 비기면 베팅한 금액을 돌려받는다.

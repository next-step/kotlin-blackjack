...
- 플레이어
  ...
  - 플레이어는 처음 카드 2장을 받았을 때 합이 21이면 BLACKJACK 상태로 바꾼다.
...
- 딜러
  ...
  - 딜러는 덱을 갖고 플레이어에게 카드를 나누어준다.
    - 처음엔 카드 2장을 받을 수 있다.
    - 그 뒤로는 카드 1장을 받는다.
  - 처음 카드 2장을 받았을 때 합이 17 이상이면 STAY 상태로 바꾼다.
...
### 요구사항 쪼개기
- 베팅 금액
  - 베팅 금액은 0 초과 100만 이하의 숫자만 가능합니다.

- 수익 계산기
  - 수익 계산기 딜러와 플레이어를 인자로 받으면 플레이어의 수익을 알려준다.

- 플레이어명
  - 플레이어명은 중복된 이름을 사용할 수 없다.

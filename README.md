...
## player
- [ ] 플레이어는 배팅 금액을 가지고 있는다.

## game state
- [ ] 승부 결과를 반환하는 것이 아닌 이율을 반환한다.
...
## bust
- [ ] bust는 bust와 승부할 경우 이율이 0이다.
- [ ] bust는 다른 카드와 승부할 경우 이율이 -1이다.

## blackjack
- [x] 2장 미만의 카드로 생성되면 예외가 발생한다.
- [x] 21이 아닌 카드로 생성되면 예외가 발생한다.
- [ ] blackjack은 blackjack과 승부할 경우 이율이 0이다.
- [ ] blackjack은 나머지 카드와 승부할 경우 이율이 1.5이다.

## hit
- [ ] hit은 bust와 승부할 경우 이율이 1이다.
- [ ] hit은 21에 가까운 수와 승부할 경우 이율이 -1이다.
- [ ] hit은 21에 먼 수와 승부할 경우 이율이 1이다.
- [ ] hit은 동일한 수와 승부할 경우 이율이 0이다.

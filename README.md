...
- [x] 겜블러들은 배팅을 할 수 있다 
- 배팅 금액 정산
  - [x] 무승부인 경우 겜블러가 배팅 금액을 돌려받는다
  - [x] 겜블러가 이기는 경우 배팅 금액을 받는다 
    - [x] 딜러가 21을 초과하면 겜블러들이 승리하므로 겜블러들은 배팅 금액을 돌려받는다
    - [x] 딜러가 21점 이하이고 겜블러가 딜러보다 점수가 높으면 승리하므로 배팅 금액을 돌려받는다 
    - [x] 겜블러의 카드가 2장이고 블랙잭(합이 21)인 경우 1.5배 받는다  

...
data class Person(val name: Name, val company: Company? = null, val skills: Skills, val languages: Languages)
...
class PersonBuilder {
    ...
    companion object {
        fun introduce(initializer: PersonBuilder.() -> Unit): Person = PersonBuilder().apply(initializer).build()
    }
}

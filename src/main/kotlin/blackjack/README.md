...
- [ ] 처음 두 장의 카드 합이 21일 경우 블랙잭이 되면 베팅 금액의 1.5 배를 딜러에게 받는다. - GameResult
- [ ] 딜러와 플레이어가 모두 동시에 블랙잭인 경우 플레이어는 베팅한 금액을 돌려받는다. (무승부) - GameResult
- [ ] 딜러와 플레이어의 최종 수익을 계산할 수 있다. - ProfitCalculator 
...
class BlackjackGame(
    ...
    fun play() {
        val dealer = Dealer()
        val playNames = inputView.inputPlayerNames()
        val betAmounts = inputView.inputPlayerBetAmounts(playNames)
        val players = Players.of(playNames = playNames, betAmounts = betAmounts, dealer = dealer)

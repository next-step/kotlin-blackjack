...
object InputView {
    ...
    tailrec fun askGamerBetting(player: Player): Int {
        val name = player.getPlayerName()
        println("$name$PLAYER_BETTING_QUESTION")
        return readLine()?.toIntOrNull() ?: askGamerBetting(player)
    }
    ...
    private const val PLAYER_BETTING_QUESTION = "의 배팅 금액은?"
}

...
class KoreanMessageSource {
    ...
    private val dualResultMap = hashMapOf(
        DualResult.WIN to "승",
        DualResult.LOSE to "패",
        DualResult.PUSH to "무",
    )

    fun nameOf(dualResult: DualResult): String {
        return dualResultMap[dualResult] ?: dualResult.name
    }

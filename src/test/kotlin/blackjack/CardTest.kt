...
class CardTest {
    ...
    fun `CardType과 NumberType으로 Card를 정의할 수 있다`(value1: SuitType, value2: NumberType, expected: Card) {
        val card = Card.of(value1, value2)
    ...
    companion object {
        ...
        fun makeCardTest(): Stream<Arguments> {
            return Stream.of(
                Arguments.of(SuitType.DIAMOND, NumberType.KING, Card.of(SuitType.DIAMOND, NumberType.KING)),
                Arguments.of(SuitType.HEART, NumberType.JACK, Card.of(SuitType.HEART, NumberType.JACK)),
                Arguments.of(SuitType.SPADE, NumberType.ACE, Card.of(SuitType.SPADE, NumberType.ACE))
            )
        }
    }
}

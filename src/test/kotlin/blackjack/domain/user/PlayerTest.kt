...
//        )
//
//        Assertions.assertThat(blackjack.isDrawable(player)).isFalse
//        org.junit.jupiter.api.assertThrows<IllegalStateException> { blackjack.drawCard(player) }
//    }
}

...
class ScenarioTest {
    private lateinit var trump: Trump
    private lateinit var batting: Batting
    ...
    fun `딜러가 지면 플레이어는 베팅 금액을 돌려받는다`() {
        ...
        player.batting(batting, battingMoney)
        batting.settleMoney(player, dealer)
    ...
    fun `플레이어 카드가 2장이고 블랙잭으로 승리했을 때 플레이어는 베팅 금액의 150%를 딜러에게 받는다`() {
        ...
        player.batting(batting, Money(10000))
        batting.settleMoney(player, dealer)
